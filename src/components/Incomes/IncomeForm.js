    ...
    <>
      ...
      <div>
        ...
        <input
          ...
          id="incomeId"
          required
          onChange={(event) => setEditId(Number(event.target.value))}
          placeholder="income id"
        />
        <button
          onClick={() =>
            setIncomeToEdit(allIncomes.find((income) => income.id === editId))
          }
        >
          Submit Id
        </button>
        ...
        <input
          value={Number(valueToChange)}
          type="number"
          id="incomeTitle"
          required
          onChange={(event) => setValueToChange(Number(event.target.value))}
          placeholder="Amout"
        />
      ...
      */}
        ...
        <input
          value={Number(editId2)}
          required
          onChange={(event) => setEditId2(Number(event.target.value))}
          type="number"
        />
        <button onClick={() => dispatch(deleteIncome(editId2))}>
          Submit Edit
        </button>
