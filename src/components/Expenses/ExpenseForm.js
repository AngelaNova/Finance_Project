...
const ExpenseForm = () => {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(
      createExpense(
        newExpense.current.amount.value,
        newExpense.current.date.value,
        newExpense.current.category.value,
        newExpense.current.description.value
      )
    );
  };
  ...
  const handleEditOfAmount = () => {
    ...
    dispatch(
      editExpense(editId.current.value, {
        ...expenseToEdit,
        amount: Number(newAmount.current.value),
      })
    );
    ...
    <div id="ExpenseManagement" className="container my-5">
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-md-8 col-lg-6">
          ...
          <form onSubmit={handleSubmit}>
            {" "}
            {/*onSubmit -> creates a new object to add to the list of expenses */}
            <div className="mb-3">
      ...
      <div className="row justify-content-center mt-4">
        <div className="col-12 col-md-8 col-lg-6">
          ...
          <div className="text-center">
            <button
              ...
              onClick={() =>
                setExpenseToEdit(
                  allExpenses.find(
                    (expense) => expense.id === editId.current.value
                  )
                )
              }
            >
            ...
            <p className="text-center">
              ...
              !expenseToEdit
                ? "No expense with such Id found"
                : editId.current.value}
            </p>

            <p>
              This is the expense you have chosen:{" "}
              {expenseToEdit ? JSON.stringify(expenseToEdit) : "None"}
            </p>
          </div>

          <p>
            Change the amount of the expense. Input the correct amount below:
          </p>
          <div className="mb-3">
            <input
              ref={newAmount}
          ...
          <p>
            Change the description of the expense. Input the correct description
            below:
          </p>
          <div className="mb-3">
            <input
          ...
          <p className="text-center">
            Delete an expense. Input the id of the expense to delete it
          </p>
          <div className=" mb-3">
            <input
              className="form-control"
            ...
            />
            <p className="text-center">
              Delete expense with id: {deleteId.current.value}
            </p>
          </div>
          <div className="text-center">
            {
